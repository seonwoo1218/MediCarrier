    ...
    <NavBarContainer>
      ...
      >
        <MedicalCardNavIcon
          ...
          alt="Medical Card"
        />
        <MediCardText selected={location.pathname === "/medi-card"}>
          의료 카드
        </MediCardText>
      </MedicalCardNavItem>
      ...
      <SearchMedicalNavItem
        to="/search-medical"
        selected={location.pathname === "/search-medical"}
      >
        <SearchMedicalNavIcon
          src={
            location.pathname === "/search-medical"
              ? SelectedSearchMedicalIcon
              : SearchMedicalIcon
          }
          alt="Search Medical"
        />
        <SearchMedicalText selected={location.pathname === "/search-medical"}>
          의료 시설 검색
        </SearchMedicalText>
      </SearchMedicalNavItem>
